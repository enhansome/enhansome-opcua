...
* [UA.NET Standard](https://github.com/OPCFoundation/UA-.NETStandard) ⭐ 2,381 | 🐛 22 | 🌐 C# | 📅 2026-09-05 - Server/Client - Official OPC UA .NET Standard Stack from the OPC Foundation. \[GPL-2.0 / RCL dual licensed]
...
* [Eclipse Milo™](https://github.com/eclipse/milo) ⭐ 1,383 | 🐛 8 | 🌐 Java | 📅 2026-09-06 - Server/Client - Java open source implementation of OPC UA (IEC 62541). \[EPL-2.0]
...
* [OPC UA for Cloud Library](https://uacloudlibrary.opcfoundation.org/) - OPC UA Information Model database with a REST and GraphQL interface ([Source](https://github.com/OPCFoundation/UA-CloudLibrary) ⭐ 49 | 🐛 7 | 🌐 C# | 📅 2026-09-04)
...
* [List of publicly availavle OPC UA Servers and Clients](https://github.com/node-opcua/node-opcua/wiki/publicly-available-OPC-UA-Servers-and-Clients) ⭐ 1,657 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-06
* `opc.tcp://milo.digitalpetri.com:62541/milo` - [Demo Server](https://github.com/eclipse/milo#public-demo-server) ⭐ 1,383 | 🐛 8 | 🌐 Java | 📅 2026-09-06 based on eclipse/milo
* [Azure OPC UA Sample](https://github.com/Azure-Samples/iot-edge-opc-plc) ⭐ 294 | 🐛 2 | 🌐 C# | 📅 2026-08-19 - sample server in c#
* `opc.tcp://opcua.umati.app:4840` - [umati Demo Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 16 | 🌐 C++ | 📅 2026-09-05 implementing different umati endorsed companion specifications, based on [open62541](https://open62541.org/)
...
* [umati Sample Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 16 | 🌐 C++ | 📅 2026-09-05 based on [open62541](https://github.com/open62541/open62541) ⭐ 3,223 | 🐛 830 | 🌐 C | 📅 2026-09-06 \[MPL-2.0]
* [UA-CloudLibrary](https://github.com/OPCFoundation/UA-CloudLibrary) ⭐ 49 | 🐛 7 | 🌐 C# | 📅 2026-09-04 - The reference implementation of the UA Cloud Library \[MIT]
...
* [OPC UA for Joining Systems](https://github.com/umati/UA-for-Industrial-Joining-Technologies) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-09-06 - Test clients and servers based on OPC UA for Joining Systems developed by VDMA Industrial Joining Technologies working group. \[APL-2.0]
...
* [open62541's List of Open Source OPC UA Implementations](https://github.com/open62541/open62541/wiki/List-of-Open-Source-OPC-UA-Implementations) ⭐ 3,223 | 🐛 830 | 🌐 C | 📅 2026-09-06 - List of open source OPC UA implementations.
