...
* [OPC Foundation Git repository of NodeSets](https://github.com/OPCFoundation/UA-Nodeset) ⭐ 277 | 🐛 18 | 🌐 C# | 📅 2026-08-18 - easy way to get the nodeset files without registration
...
* [OPC UA for Devs in 10 Minutes](https://github.com/umati/hackathon/blob/main/2nd_hackathon/Presentations/20230516_OpcUaIn10Minutes.pdf) ⭐ 3 | 🐛 3 | 🌐 C# | 📅 2026-08-21 - short presentation for developers to grasp the concept of OPC UA information modelling
...
* [freeopcua](https://github.com/FreeOpcUa/freeopcua) ⭐ 786 | 🐛 143 | 🌐 C++ | 📅 2024-08-14 - Open Source C++ OPC-UA Server and Client Library. \[LGPL-3.0]
...
* [UA.NET Standard](https://github.com/OPCFoundation/UA-.NETStandard) ⭐ 2,374 | 🐛 19 | 🌐 C# | 📅 2026-08-24 - Server/Client - Official OPC UA .NET Standard Stack from the OPC Foundation. \[GPL-2.0 / RCL dual licensed]
...
* [Eclipse Milo™](https://github.com/eclipse/milo) ⭐ 1,382 | 🐛 4 | 🌐 Java | 📅 2026-08-19 - Server/Client - Java open source implementation of OPC UA (IEC 62541). \[EPL-2.0]
...
* [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,466 | 🐛 241 | 🌐 Python | 📅 2026-08-24 - OPC UA / IEC 62541 Client and Server for Python >= 3.7 and pypy3. \[LGPL-3.0]
...
* [gopcua/opcua](https://github.com/gopcua/opcua) ⭐ 1,057 | 🐛 26 | 🌐 Go | 📅 2026-08-09 - Server/Client - A native Go implementation of the OPC/UA Binary Protocol. \[MIT]
...
* [FreeOpcUA](https://github.com/FreeOpcUa/opcua-client-gui) ⭐ 669 | 🐛 57 | 🌐 Python | 📅 2026-08-05 - OpenSource Client based on python. \[GPL-3.0]
* [opcilloscope](https://github.com/SquareWaveSystems/opcilloscope) ⭐ 146 | 🐛 1 | 🌐 C# | 📅 2026-07-16 - Lightweight, cross-platform terminal-based OPC UA client with real-time oscilloscope view. Keyboard and mouse friendly. \[MIT]
...
* [UA-ModelCompiler](https://github.com/OPCFoundation/UA-ModelCompiler) ⭐ 171 | 🐛 30 | 🌐 C# | 📅 2026-08-01 - Tool to convert OPC UA Information models in Model.xml format to NodeSet2.xml Format. \[MIT]
...
* [List of publicly availavle OPC UA Servers and Clients](https://github.com/node-opcua/node-opcua/wiki/publicly-available-OPC-UA-Servers-and-Clients) ⭐ 1,655 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-25
* `opc.tcp://milo.digitalpetri.com:62541/milo` - [Demo Server](https://github.com/eclipse/milo#public-demo-server) ⭐ 1,382 | 🐛 4 | 🌐 Java | 📅 2026-08-19 based on eclipse/milo
* [Azure OPC UA Sample](https://github.com/Azure-Samples/iot-edge-opc-plc) ⭐ 293 | 🐛 1 | 🌐 C# | 📅 2026-08-19 - sample server in c#
* `opc.tcp://opcua.umati.app:4840` - [umati Demo Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 16 | 🌐 C++ | 📅 2026-08-25 implementing different umati endorsed companion specifications, based on [open62541](https://open62541.org/)
* `opc.tcp://opcua.umati.app:4843` - [umati Demo Server 3](https://github.com/umati/Sample-Server-node-opcua) ⭐ 21 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21 implementing different umati endorsed companion specifications, based on [node-opcua](https://node-opcua.github.io/)
...
* `opc.tcp://opcua.umati.app:4842` - [umati Demo Server 2](https://github.com/umati/Sample-Server-asyncio) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2026-08-18 implementing different umati endorsed companion specifications, based on [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,466 | 🐛 241 | 🌐 Python | 📅 2026-08-24
...
* [umati Sample Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 16 | 🌐 C++ | 📅 2026-08-25 based on [open62541](https://github.com/open62541/open62541) ⭐ 3,215 | 🐛 826 | 🌐 C | 📅 2026-08-25 \[MPL-2.0]
...
* [umati Sample Server 2](https://github.com/umati/Sample-Server-asyncio) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2026-08-18 based on [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,466 | 🐛 241 | 🌐 Python | 📅 2026-08-24 \[APL-2.0]
...
* [OPC UA for Joining Systems](https://github.com/umati/UA-for-Industrial-Joining-Technologies) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-08-25 - Test clients and servers based on OPC UA for Joining Systems developed by VDMA Industrial Joining Technologies working group. \[APL-2.0]
...
* [opcua-machinery-client](https://github.com/AndreasHeine/opcua-machinery-client) ⭐ 5 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-20 - Client example showcaseing the OPC UA for Machinery from a data consumer perspective. \[MIT]
...
* [open62541's List of Open Source OPC UA Implementations](https://github.com/open62541/open62541/wiki/List-of-Open-Source-OPC-UA-Implementations) ⭐ 3,215 | 🐛 826 | 🌐 C | 📅 2026-08-25 - List of open source OPC UA implementations.
...
* (WIP) [OPC UA Tutorials](https://github.com/AndreasHeine/opcua-tutorial) ⭐ 36 | 🐛 1 | 🌐 Python | 📅 2025-03-06 - Tutorial for [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,466 | 🐛 241 | 🌐 Python | 📅 2026-08-24
