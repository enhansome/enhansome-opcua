...
* [OPC Foundation Git repository of NodeSets](https://github.com/OPCFoundation/UA-Nodeset) ⭐ 279 | 🐛 20 | 🌐 C# | 📅 2026-08-18 - easy way to get the nodeset files without registration
...
* [OPC UA for Devs in 10 Minutes](https://github.com/umati/hackathon/blob/main/2nd_hackathon/Presentations/20230516_OpcUaIn10Minutes.pdf) ⭐ 3 | 🐛 6 | 🌐 C# | 📅 2026-09-10 - short presentation for developers to grasp the concept of OPC UA information modelling
...
* [UA.NET Standard](https://github.com/OPCFoundation/UA-.NETStandard) ⭐ 2,384 | 🐛 15 | 🌐 C# | 📅 2026-09-10 - Server/Client - Official OPC UA .NET Standard Stack from the OPC Foundation. \[GPL-2.0 / RCL dual licensed]
* [opc-ua-client](https://github.com/convertersystems/opc-ua-client) ⭐ 467 | 🐛 29 | 🌐 C# | 📅 2025-09-01- only Client \[MIT]
* [LibUA](https://github.com/nauful/LibUA) ⭐ 345 | 🐛 0 | 🌐 C# | 📅 2026-08-30 - Server/Client \[Apache-2.0]
...
* [Eclipse Milo™](https://github.com/eclipse/milo) ⭐ 1,384 | 🐛 6 | 🌐 Java | 📅 2026-09-10 - Server/Client - Java open source implementation of OPC UA (IEC 62541). \[EPL-2.0]
...
* [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,477 | 🐛 247 | 🌐 Python | 📅 2026-09-10 - OPC UA / IEC 62541 Client and Server for Python >= 3.7 and pypy3. \[LGPL-3.0]
...
* [gopcua/opcua](https://github.com/gopcua/opcua) ⭐ 1,059 | 🐛 31 | 🌐 Go | 📅 2026-08-09 - Server/Client - A native Go implementation of the OPC/UA Binary Protocol. \[MIT]
* [awcullen/opcua](https://github.com/awcullen/opcua) ⭐ 113 | 🐛 7 | 🌐 Go | 📅 2026-02-08 - Server/Client. \[MIT]
...
* [FreeOpcUA](https://github.com/FreeOpcUa/opcua-client-gui) ⭐ 674 | 🐛 57 | 🌐 Python | 📅 2026-08-05 - OpenSource Client based on python. \[GPL-3.0]
...
* [OPC UA for Cloud Library](https://uacloudlibrary.opcfoundation.org/) - OPC UA Information Model database with a REST and GraphQL interface ([Source](https://github.com/OPCFoundation/UA-CloudLibrary) ⭐ 49 | 🐛 7 | 🌐 C# | 📅 2026-09-09)
...
* [List of publicly availavle OPC UA Servers and Clients](https://github.com/node-opcua/node-opcua/wiki/publicly-available-OPC-UA-Servers-and-Clients) ⭐ 1,658 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-10
* `opc.tcp://milo.digitalpetri.com:62541/milo` - [Demo Server](https://github.com/eclipse/milo#public-demo-server) ⭐ 1,384 | 🐛 6 | 🌐 Java | 📅 2026-09-10 based on eclipse/milo
* [Azure OPC UA Sample](https://github.com/Azure-Samples/iot-edge-opc-plc) ⭐ 295 | 🐛 7 | 🌐 C# | 📅 2026-09-07 - sample server in c#
* `opc.tcp://opcua.umati.app:4840` - [umati Demo Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 16 | 🌐 C++ | 📅 2026-09-10 implementing different umati endorsed companion specifications, based on [open62541](https://open62541.org/)
...
* `opc.tcp://opcua.umati.app:4842` - [umati Demo Server 2](https://github.com/umati/Sample-Server-asyncio) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2026-09-01 implementing different umati endorsed companion specifications, based on [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,477 | 🐛 247 | 🌐 Python | 📅 2026-09-10
...
* [umati Sample Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 16 | 🌐 C++ | 📅 2026-09-10 based on [open62541](https://github.com/open62541/open62541) ⭐ 3,223 | 🐛 828 | 🌐 C | 📅 2026-09-09 \[MPL-2.0]
* [UA-CloudLibrary](https://github.com/OPCFoundation/UA-CloudLibrary) ⭐ 49 | 🐛 7 | 🌐 C# | 📅 2026-09-09 - The reference implementation of the UA Cloud Library \[MIT]
...
* [umati Sample Server 2](https://github.com/umati/Sample-Server-asyncio) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2026-09-01 based on [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,477 | 🐛 247 | 🌐 Python | 📅 2026-09-10 \[APL-2.0]
...
* [OPC UA for Joining Systems](https://github.com/umati/UA-for-Industrial-Joining-Technologies) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-09-10 - Test clients and servers based on OPC UA for Joining Systems developed by VDMA Industrial Joining Technologies working group. \[APL-2.0]
...
* [opcua-machinery-client](https://github.com/AndreasHeine/opcua-machinery-client) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-10 - Client example showcaseing the OPC UA for Machinery from a data consumer perspective. \[MIT]
...
* [open62541's List of Open Source OPC UA Implementations](https://github.com/open62541/open62541/wiki/List-of-Open-Source-OPC-UA-Implementations) ⭐ 3,223 | 🐛 828 | 🌐 C | 📅 2026-09-09 - List of open source OPC UA implementations.
* [Agile-IoT/awesome-open-iot](https://github.com/Agile-IoT/awesome-open-iot) ⭐ 708 | 🐛 8 | 📅 2023-12-21 - A curated list of awesome open source IoT frameworks, libraries and software.
...
* (WIP) [OPC UA Tutorials](https://github.com/AndreasHeine/opcua-tutorial) ⭐ 36 | 🐛 1 | 🌐 Python | 📅 2025-03-06 - Tutorial for [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,477 | 🐛 247 | 🌐 Python | 📅 2026-09-10
