...
* [OPC Foundation Git repository of NodeSets](https://github.com/OPCFoundation/UA-Nodeset) ⭐ 279 | 🐛 23 | 🌐 C# | 📅 2026-08-18 - easy way to get the nodeset files without registration
...
* [UA.NET Standard](https://github.com/OPCFoundation/UA-.NETStandard) ⭐ 2,387 | 🐛 22 | 🌐 C# | 📅 2026-09-16 - Server/Client - Official OPC UA .NET Standard Stack from the OPC Foundation. \[GPL-2.0 / RCL dual licensed]
* [opc-ua-client](https://github.com/convertersystems/opc-ua-client) ⭐ 468 | 🐛 29 | 🌐 C# | 📅 2025-09-01- only Client \[MIT]
* [LibUA](https://github.com/nauful/LibUA) ⭐ 345 | 🐛 1 | 🌐 C# | 📅 2026-08-30 - Server/Client \[Apache-2.0]
...
* [Eclipse Milo™](https://github.com/eclipse/milo) ⭐ 1,388 | 🐛 6 | 🌐 Java | 📅 2026-09-16 - Server/Client - Java open source implementation of OPC UA (IEC 62541). \[EPL-2.0]
...
* [gopcua/opcua](https://github.com/gopcua/opcua) ⭐ 1,060 | 🐛 32 | 🌐 Go | 📅 2026-09-16 - Server/Client - A native Go implementation of the OPC/UA Binary Protocol. \[MIT]
...
* [OPC UA for Cloud Library](https://uacloudlibrary.opcfoundation.org/) - OPC UA Information Model database with a REST and GraphQL interface ([Source](https://github.com/OPCFoundation/UA-CloudLibrary) ⭐ 49 | 🐛 5 | 🌐 C# | 📅 2026-09-15)
...
* [List of publicly availavle OPC UA Servers and Clients](https://github.com/node-opcua/node-opcua/wiki/publicly-available-OPC-UA-Servers-and-Clients) ⭐ 1,659 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-16
* `opc.tcp://milo.digitalpetri.com:62541/milo` - [Demo Server](https://github.com/eclipse/milo#public-demo-server) ⭐ 1,388 | 🐛 6 | 🌐 Java | 📅 2026-09-16 based on eclipse/milo
* [Azure OPC UA Sample](https://github.com/Azure-Samples/iot-edge-opc-plc) ⭐ 295 | 🐛 2 | 🌐 C# | 📅 2026-09-16 - sample server in c#
* `opc.tcp://opcua.umati.app:4840` - [umati Demo Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 20 | 🌐 C++ | 📅 2026-09-16 implementing different umati endorsed companion specifications, based on [open62541](https://open62541.org/)
...
* `opc.tcp://opcua.umati.app:4842` - [umati Demo Server 2](https://github.com/umati/Sample-Server-asyncio) ⭐ 14 | 🐛 3 | 🌐 Python | 📅 2026-09-15 implementing different umati endorsed companion specifications, based on [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,480 | 🐛 244 | 🌐 Python | 📅 2026-09-16
...
* [umati Sample Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 20 | 🌐 C++ | 📅 2026-09-16 based on [open62541](https://github.com/open62541/open62541) ⭐ 3,228 | 🐛 831 | 🌐 C | 📅 2026-09-16 \[MPL-2.0]
* [UA-CloudLibrary](https://github.com/OPCFoundation/UA-CloudLibrary) ⭐ 49 | 🐛 5 | 🌐 C# | 📅 2026-09-15 - The reference implementation of the UA Cloud Library \[MIT]
...
* [umati Sample Server 2](https://github.com/umati/Sample-Server-asyncio) ⭐ 14 | 🐛 3 | 🌐 Python | 📅 2026-09-15 based on [opcua-asyncio](https://github.com/FreeOpcUa/opcua-asyncio) ⭐ 1,480 | 🐛 244 | 🌐 Python | 📅 2026-09-16 \[APL-2.0]
...
* [OPC UA for Joining Systems](https://github.com/umati/UA-for-Industrial-Joining-Technologies) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-09-16 - Test clients and servers based on OPC UA for Joining Systems developed by VDMA Industrial Joining Technologies working group. \[APL-2.0]
