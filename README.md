...
* [OPC Foundation Git repository of NodeSets](https://github.com/OPCFoundation/UA-Nodeset) ⭐ 280 | 🐛 38 | 🌐 C# | 📅 2026-08-18 - easy way to get the nodeset files without registration
...
* [OPC UA for Devs in 10 Minutes](https://github.com/umati/hackathon/blob/main/2nd_hackathon/Presentations/20230516_OpcUaIn10Minutes.pdf) ⭐ 3 | 🐛 11 | 🌐 C# | 📅 2026-09-21 - short presentation for developers to grasp the concept of OPC UA information modelling
...
* [UA.NET Standard](https://github.com/OPCFoundation/UA-.NETStandard) ⭐ 2,389 | 🐛 23 | 🌐 C# | 📅 2026-09-21 - Server/Client - Official OPC UA .NET Standard Stack from the OPC Foundation. \[GPL-2.0 / RCL dual licensed]
...
* [Eclipse Milo™](https://github.com/eclipse/milo) ⭐ 1,388 | 🐛 6 | 🌐 Java | 📅 2026-09-21 - Server/Client - Java open source implementation of OPC UA (IEC 62541). \[EPL-2.0]
...
* [gopcua/opcua](https://github.com/gopcua/opcua) ⭐ 1,061 | 🐛 33 | 🌐 Go | 📅 2026-09-17 - Server/Client - A native Go implementation of the OPC/UA Binary Protocol. \[MIT]
...
* [OPC UA for Cloud Library](https://uacloudlibrary.opcfoundation.org/) - OPC UA Information Model database with a REST and GraphQL interface ([Source](https://github.com/OPCFoundation/UA-CloudLibrary) ⭐ 49 | 🐛 3 | 🌐 C# | 📅 2026-09-21)
...
* [List of publicly availavle OPC UA Servers and Clients](https://github.com/node-opcua/node-opcua/wiki/publicly-available-OPC-UA-Servers-and-Clients) ⭐ 1,660 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-21
* `opc.tcp://milo.digitalpetri.com:62541/milo` - [Demo Server](https://github.com/eclipse/milo#public-demo-server) ⭐ 1,388 | 🐛 6 | 🌐 Java | 📅 2026-09-21 based on eclipse/milo
* [Azure OPC UA Sample](https://github.com/Azure-Samples/iot-edge-opc-plc) ⭐ 295 | 🐛 7 | 🌐 C# | 📅 2026-09-21 - sample server in c#
...
* [umati Sample Server](https://github.com/umati/Sample-Server) ⭐ 61 | 🐛 15 | 🌐 C++ | 📅 2026-09-19 based on [open62541](https://github.com/open62541/open62541) ⭐ 3,233 | 🐛 833 | 🌐 C | 📅 2026-09-21 \[MPL-2.0]
* [UA-CloudLibrary](https://github.com/OPCFoundation/UA-CloudLibrary) ⭐ 49 | 🐛 3 | 🌐 C# | 📅 2026-09-21 - The reference implementation of the UA Cloud Library \[MIT]
...
* [OPC UA for Joining Systems](https://github.com/umati/UA-for-Industrial-Joining-Technologies) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - Test clients and servers based on OPC UA for Joining Systems developed by VDMA Industrial Joining Technologies working group. \[APL-2.0]
...
* [opcua-machinery-client](https://github.com/AndreasHeine/opcua-machinery-client) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-20 - Client example showcaseing the OPC UA for Machinery from a data consumer perspective. \[MIT]
...
* [open62541's List of Open Source OPC UA Implementations](https://github.com/open62541/open62541/wiki/List-of-Open-Source-OPC-UA-Implementations) ⭐ 3,233 | 🐛 833 | 🌐 C | 📅 2026-09-21 - List of open source OPC UA implementations.
